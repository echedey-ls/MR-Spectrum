...
poa_irrad_modified = poa_irrad * mr_spectrum_modifiers
...
#                                      * mr_spectrum_modifiers[component])
...
poa_irrad_modified_with_ratios["poa_global"] = (
    ...
    + poa_irrad_modified_with_ratios["poa_sky_diffuse"]
    + poa_irrad_modified_with_ratios["poa_ground_diffuse"]
)
